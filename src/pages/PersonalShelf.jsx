...
export default function PersonalShelf() {
  ...
  const savedBooksLocalStorage = JSON.parse(localStorage.getItem("personalBooks"));
  ...
  return (
    <div className='h-full  bg-sandybrown'>
      ...
      <div style={{backgroundImage:`url(${shelf})`}} className='w-full h-full pt-28'>
            ...
            return (
              <div key={index}>
                  <div  className='p-4 bg-white  border-pink m-4 shadow-2xl	 py-12 rounded-md ' >
                    ...
                    <h2 className='text-xs mt-2 flex justify-center'>Publisher : {book.publisher}</h2>
                    <h2 className='text-xs mt-2 flex justify-center'>Publish Date : {book.date}</h2>
                    <h2 className='text-xs mt-2 flex justify-center'>Type: {book.type}</h2>
                    <h2 className='text-xs mt-2 flex justify-center'>Subject: {book.subject1} {book.subject2}</h2>
